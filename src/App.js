...
function App() {
  const input = [
    ...
    { id: "n10", name: "name10", gender: "female", parentId: "n8", spouse: "",spouceForChild:'' },
  ...
  return (
    <div>
      <Tree distanceByX={75} distanceByY={50} textFontSize='12px' childsLineColor="#ccc" spouseLineColor='green ' arrowHeadSize={2} WIDTH='40px' HEIGHT="50px" inputData={input} />
    </div>
  );
}
